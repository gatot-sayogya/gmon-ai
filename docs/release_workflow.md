...
This document explains how releases are created and published for the Gmon AI plugin.
...
```
https://github.com/gatot-sayogya/gmon-ai/releases
```

Each release includes a zip archive (`gmon-ai-x.y.z.zip`) containing the built plugin ready for installation.
