...
const formatContext = (dashboard: DashboardContext, user: UserContext, dataSources: DataSourceContext[]): string => {
  ...
  lines.push(
    `You are Gmon AI, an AI assistant embedded in Grafana. ` +
        ...
        <div className={styles.landingContainer}>
          <div className={styles.landingContent}>
            ...
            <div className={styles.logo}>
              <img src="public/plugins/gmon-ai/img/logo.svg" alt="Gmon AI Assistant" className={styles.logoImage} />
            </div>
            ...
            <div className={styles.footerLinks}>
              <div className={styles.footerLink} onClick={() => navigate('prompts')} data-testid="prompt-library-link">
                <img src="public/plugins/gmon-ai/img/prompt-library-icon.png" alt="Prompt Library" className={styles.iconImage} />
                <div>
              ...
              <div className={styles.footerLink} onClick={() => navigate('history')} data-testid="previous-conversations-link">
                <img src="public/plugins/gmon-ai/img/previous-conversations-icon.png" alt="Previous Conversations" className={styles.iconImage} />
                <div>
              ...
              <div className={styles.footerLink} onClick={handleReviewPrompt} data-testid="refine-prompt-link">
                <img src="public/plugins/gmon-ai/img/refine-prompt-icon.png" alt="Refine my prompt" className={styles.iconImage} />
                <div>
        ...
        <>
          ...
          <div className={styles.inputArea}>
            ...
            {selectedFiles.length > 0 && (
              ...
              Gmon AI can make mistakes. Please double-check responses.
            </div>
            <div className={`${styles.inputWrapper} ${isLoading ? styles.inputWrapperLoading : ''} `}>
              <TextArea
                ...
                value={input}
                onChange={(e) => setInput(e.currentTarget.value)}
                placeholder={!llmReady ? 'Configure Grafana LLM plugin to send messages...' : 'Ask Gmon AI'}
                rows={2}
