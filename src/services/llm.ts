        ...
        try {
            ...
            if (response.choices && response.choices.length > 0) {
                    ...
                    llmMessages.push({
                        ...
                        for (const toolCall of toolCalls) {
                            ...
                            try {
                                ...
                                console.error(`[Gmon AI] Tool execution failed: ${error.message}`);
                                llmMessages.push({
                                    role: 'tool',
                ...
                if (iteration >= MAX_ITERATIONS) {
                    console.warn('[Gmon AI] Max tool calling iterations reached, stopping');
                }
            ...
            console.error('[Gmon AI] Chat Error:', error);
            console.error('[Gmon AI] Error details:', {
                name: error.name,
