...
describe('ChatHistoryService', () => {
    ...
    describe('Pinning', () => {
        ...
        it('should sort pinned sessions first', () => {
            ...
            const storedSessions = JSON.parse(localStorage.getItem('gmon_ai_chat_history') || '[]');
            ...
            localStorage.setItem('gmon_ai_chat_history', JSON.stringify(storedSessions));
    ...
    describe('Cleanup', () => {
        it('should preserve pinned sessions during cleanup', () => {
            ...
            const sessions = JSON.parse(localStorage.getItem('gmon_ai_chat_history') || '[]');
            sessions[0].createdAt = oldDate;
            localStorage.setItem('gmon_ai_chat_history', JSON.stringify(sessions));
            ...
            // Manually set old date
            const sessions2 = JSON.parse(localStorage.getItem('gmon_ai_chat_history') || '[]');
            sessions2[1].createdAt = oldDate;
            localStorage.setItem('gmon_ai_chat_history', JSON.stringify(sessions2));
